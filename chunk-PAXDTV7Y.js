...
var l0 = Qo(c0.exports),
  ...
  At = class e {
    ...
    static init(t) {
      var n;
      return (
        Y("[Ethereum: init()] Initializing Ethereum service"),
  ...
  return J(this, void 0, void 0, function* () {
    ...
    try {
      ...
      if (!e && window.ethereum)
        return Wa({ provider: window.ethereum, sdkInstance: t });
  ...
  return J(this, void 0, void 0, function* () {
    ...
    let {
      ...
      return J(this, void 0, void 0, function* () {
        ...
        } else !((N = S.platformManager) === null || N === void 0) && N.isMetaMaskMobileWebView() && ((I = S.analytics) === null || I === void 0 || I.send({ event: Le.SDK_USE_INAPP_BROWSER }), (S.activeProvider = Wa({ provider: window.ethereum, sdkInstance: S })), (S._initialized = !0), (U = !0));
        return (
          z &&
            q.extensionOnly &&
            (Y(
...
var Cd = class extends _r.default {
    ...
    checkExtensionAvailability() {
      ...
      return (
        typeof window < "u" &&
        !!(!((t = window.ethereum) === null || t === void 0) && t.isMetaMask)
      );
    }
    connect() {
      return J(this, void 0, void 0, function* () {

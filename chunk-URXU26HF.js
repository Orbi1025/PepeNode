import {
  ...
  y as or,
  z as ze,
} from "./chunk-VYSOZBOM.js";
import { a as cr } from "./chunk-7JYJOSII.js";
import { a as d, b as v, d as Je, l as g } from "./chunk-JOVT4LBN.js";
  ...
  let { domain: r, message: t, primaryType: o, types: n } = e,
    i = (s, a) => {
      for (let m of s) {
        ...
        if (p === "address" && typeof l == "string" && !rr(l))
          throw new Qe({ address: l });
        let f = p.match(tr);
        if (f) {
          let [E, y] = f;
...
function Vr({ primaryType: e, types: r }) {
  let t = A(jr({ primaryType: e, types: r }));
  return P(t);
}
...
function yr({ types: e, name: r, type: t, value: o }) {
  ...
  if (t === "string") return [{ type: "bytes32" }, P(A(o))];
...
function Tr(e) {
  return Array.isArray(e) ? Jr(e.map((r) => Tr(r))) : Zr(e);
}
function Jr(e) {
...
function Ur(e) {
  ...
  return (
    e.authorizationList && (r.authorizationList = Xr(e.authorizationList)),
    (r.yParity = (() => {
...
function In({ chain: e, currentChainId: r }) {
  if (!e) throw new pr();
  if (r !== e.id) throw new mr({ chain: e, currentChainId: r });
}
function je(
  e,
...
var tt = { "0x0": "reverted", "0x1": "success" };
function Rn(e) {
  let r = v(d({}, e), {
    blockNumber: e.blockNumber ? BigInt(e.blockNumber) : null,
...
function ot(e) {
  let {
    ...
    l = e.cacheTime ?? p,
    u = e.account ? nr(e.account) : void 0,
    {
      config: f,
      request: c,
      value: E,
    ...
    request(o) {
      return g(this, null, function* () {
        ...
        try {
              ...
              g(this, [E], function* ({ signal: c }) {
                let y = v(d({}, m), {
                    body: Array.isArray(n)
                      ? H(
                          n.map((D) =>
                            d({ jsonrpc: "2.0", id: D.id ?? Ke.take() }, D)
                          )
                        )
                      : H(d({ jsonrpc: "2.0", id: n.id ?? Ke.take() }, n)),
          ...
          throw u instanceof M || u instanceof qe
            ? u

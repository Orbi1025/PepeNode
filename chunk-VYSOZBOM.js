...
function Yn(e) {
  return b(
    ...
    e.withdrawals && { withdrawals: e.withdrawals.map(Jn) }
  );
}
function ne(e) {
  ...
  constructor(t, n = {}) {
    let r =
        n.cause instanceof e
          ...
          : n.details,
      o = (n.cause instanceof e && n.cause.docsPath) || n.docsPath,
      s = zt.getDocsUrl?.(A(b({}, n), { docsPath: o })),
      i = [
        t || "An error occurred.",
        "",
        ...(n.metaMessages ? [...n.metaMessages, ""] : []),
...
function Le(e, { includeName: t = !1 } = {}) {
  return e ? e.map((n) => vo(n, { includeName: t })).join(t ? ", " : ",") : "";
}
...
function I(e, { size: t }) {
  if (x(e) > t) throw new et({ givenSize: x(e), maxSize: t });
}
function Ot(e, t = {}) {
  let { signed: n } = t;
...
function mi(e, t = {}) {
  let n = ue(e);
  return (
    t.size && (I(n, { size: t.size }), (n = K(n, { dir: "right" }))),
    new TextDecoder().decode(n)
  );
}
var Po = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function pr(e, t = {}) {
...
function Ft(e, t = {}) {
  ...
  return typeof t.size == "number"
    ? (I(n, { size: t.size }), _(n, { size: t.size }))
    : n;
}
function S(e, t = {}) {
  let n = "";
  for (let o = 0; o < e.length; o++) n += Po[e[o]];
  let r = `0x${n}`;
  return typeof t.size == "number"
    ? (I(r, { size: t.size }), _(r, { dir: "right", size: t.size }))
    : r;
}
function y(e, t = {}) {
  let { signed: n, size: r } = t,
...
function ue(e, t = {}) {
  let n = e;
  t.size &&
    (I(n, { size: t.size }), (n = _(n, { dir: "right", size: t.size })));
  let r = n.slice(2);
  r.length % 2 && (r = `0${r}`);
  let o = r.length / 2,
    s = new Uint8Array(o);
...
function kt(e, t = {}) {
  let n = To.encode(e);
  return typeof t.size == "number"
    ? (I(n, { size: t.size }), _(n, { dir: "right", size: t.size }))
    : n;
}
var Bo = BigInt(0),
  je = BigInt(1),
  ...
  for (let r = 24 - t; r < 24; r++) {
    ...
    for (let i = 0; i < 10; i += 2) {
      let a = (i + 8) % 10,
        ...
        d = fr(p, f, 1) ^ n[a],
        m = lr(p, f, 1) ^ n[a + 1];
      for (let l = 0; l < 50; l += 10) (e[i + l] ^= d), (e[i + l + 1] ^= m);
    }
    let o = e[2],
      s = e[3];
    for (let i = 0; i < 24; i++) {
...
var Ut = class e extends Gn {
    constructor(t, n, r, o = !1, s = 24) {
      ...
      (this.state = new Uint8Array(200)), (this.state32 = Ln(this.state));
    }
    clone() {
...
var Nt = new ce(8192);
function ze(e, t) {
  if (Nt.has(`${e}.${t}`)) return Nt.get(`${e}.${t}`);
  ...
  let s = `0x${o.join("")}`;
  return Nt.set(`${e}.${t}`, s), s;
}
function ia(e, t) {
  if (!w(e, { strict: !1 })) throw new T({ address: e });
  return ze(e, t);
}
...
var No = {
  ...
  assertPosition(e) {
    if (e < 0 || e > this.bytes.length - 1)
      throw new ot({ length: this.bytes.length, position: e });
  },
  decrementPosition(e) {
    if (e < 0) throw new Re({ offset: e });
...
function Ar(e, t = {}) {
  typeof t.size < "u" && I(e, { size: t.size });
  let n = S(e, t);
  return Ot(n, t);
}
function Pr(e, t = {}) {
  let n = e;
  if (
    (typeof t.size < "u" && (I(n, { size: t.size }), (n = K(n))),
    n.length > 1 || n[0] > 1)
  )
    throw new Qe(n);
  return !!n[0];
...
function Ir(e, t = {}) {
  ...
  return (
    typeof t.size < "u" &&
      (I(n, { size: t.size }), (n = K(n, { dir: "right" }))),
    new TextDecoder().decode(n)
  );
}
function D(e) {
...
function C(e, t) {
  ...
  let n = Do({ params: e, values: t }),
    r = Dt(n);
  return r.length === 0 ? "0x" : r;
}
function Do({ params: e, values: t }) {
  let n = [];
  for (let r = 0; r < e.length; r++) n.push(Lt({ param: e[r], value: t[r] }));
  return n;
}
function Lt({ param: e, value: t }) {
  ...
  if (n) {
    let [r, o] = n;
    return Vo(t, { length: r, param: A(b({}, e), { type: o }) });
  }
  if (e.type === "tuple") return Jo(t, { param: e });
  if (e.type === "address") return Go(t);
  if (e.type === "bool") return _o(t);
  if (e.type.startsWith("uint") || e.type.startsWith("int")) {
    let r = e.type.startsWith("int"),
      [, , o = "256"] = Tr.exec(e.type) ?? [];
    return qo(t, { signed: r, size: Number(o) });
  }
  if (e.type.startsWith("bytes")) return Wo(t, { param: e });
  if (e.type === "string") return Xo(t);
  throw new Ze(e.type, { docsPath: "/docs/contract/encodeAbiParameters" });
}
function Dt(e) {
  let t = 0;
...
function Go(e) {
  if (!w(e)) throw new T({ address: e });
  return { dynamic: !1, encoded: N(e.toLowerCase()) };
}
function Vo(e, { length: t, param: n }) {
  ...
  if (r || o) {
    ...
    if (r) {
      ...
      return { dynamic: !0, encoded: s.length > 0 ? D([a, i]) : a };
    }
    if (o) return { dynamic: !0, encoded: i };
  }
  return { dynamic: !1, encoded: D(s.map(({ encoded: i }) => i)) };
}
function Wo(e, { param: t }) {
  ...
  if (!n) {
    ...
    return (
      ...
      { dynamic: !0, encoded: D([N(y(r, { size: 32 })), o]) }
    );
  }
  if (r !== Number.parseInt(n))
    throw new _e({ expectedSize: Number.parseInt(n), value: e });
  return { dynamic: !1, encoded: N(e, { dir: "right" }) };
}
function _o(e) {
  if (typeof e != "boolean")
    throw new u(
  ...
  return { dynamic: !1, encoded: N(Ft(e)) };
}
...
function Xo(e) {
  let t = Ct(e),
    ...
    r = [];
  for (let o = 0; o < n; o++)
    r.push(N(R(t, o * 32, (o + 1) * 32), { dir: "right" }));
  return { dynamic: !0, encoded: D([N(y(x(t), { size: 32 })), ...r]) };
}
function Jo(e, { param: t }) {
  ...
  for (let o = 0; o < t.components.length; o++) {
    let s = t.components[o],
      ...
      a = Lt({ param: s, value: e[i] });
    r.push(a), a.dynamic && (n = !0);
  }
  return { dynamic: n, encoded: n ? Dt(r) : D(r.map(({ encoded: o }) => o)) };
}
function it(e) {
  let t = e.match(/^(.*)\[(\d+)?\]$/);
...
function pe(e, t, { staticPosition: n }) {
  ...
  if (r) {
    let [o, s] = r;
    return Zo(e, A(b({}, t), { type: s }), { length: o, staticPosition: n });
  }
  if (t.type === "tuple") return ts(e, t, { staticPosition: n });
  if (t.type === "address") return Yo(e);
  if (t.type === "bool") return Ko(e);
  if (t.type.startsWith("bytes")) return Qo(e, t, { staticPosition: n });
  if (t.type.startsWith("uint") || t.type.startsWith("int")) return es(e, t);
  if (t.type === "string") return ns(e, { staticPosition: n });
  throw new Ke(t.type, { docsPath: "/docs/contract/decodeAbiParameters" });
}
var Mr = 32,
  Gt = 32;
function Yo(e) {
...
function Zo(e, t, { length: n, staticPosition: r }) {
  if (!n) {
    ...
    return e.setPosition(r + 32), [m, 32];
  }
  if (Oe(t)) {
    let i = F(e.readBytes(Gt)),
      a = r + i,
...
function Ko(e) {
  return [Pr(e.readBytes(32), { size: 32 }), 32];
}
...
function es(e, t) {
  let n = t.type.startsWith("int"),
    ...
    o = e.readBytes(32);
  return [r > 48 ? Ar(o, { signed: n }) : F(o, { signed: n }), 32];
}
  ...
  switch (r) {
    ...
    default:
      return r === "tuple" && "components" in t
        ...
        ? Array.isArray(e) &&
          e.every((o) =>
            Wt(o, A(b({}, t), { type: r.replace(/(\[[0-9]{0,}\])$/, "") }))
          )
        : !1;
  }
}
...
var Fr = class extends u {
    constructor(
      ...
      let l = Fe({
        ...
        to: d,
        value:
          typeof m < "u" && `${ct(m)} ${o?.nativeCurrency?.symbol || "ETH"}`,
        data: s,
        gas: i,
      ...
      if (n && n !== "0x")
        try {
          ...
          if (d === "Error") c = m[0];
            ...
            let l = f ? P(f, { includeName: !0 }) : void 0,
              h =
                f && m
                  ? Vt({
                      abiItem: f,
...
function Gr(e) {
  let { abi: t, args: n, functionName: r, data: o } = e,
    s = t[0];
  if (r) {
    let a = U({ abi: t, args: n, name: r });
    if (!a) throw new z(r, { docsPath: _t });
    s = a;
  }
  if (s.type !== "function") throw new z(void 0, { docsPath: _t });
  if (!s.outputs) throw new se(s.name, { docsPath: _t });
...
function Xt(e) {
  ...
  if (!o) throw new Ge({ docsPath: qt });
  if (!("inputs" in o)) throw new Te({ docsPath: qt });
  if (!o.inputs || o.inputs.length === 0) throw new Te({ docsPath: qt });
  let s = C(o.inputs, n);
  return Q([r, s]);
}
...
function Wr(e) {
  let { abi: t, args: n, functionName: r } = e,
    o = t[0];
  if (r) {
    let s = U({ abi: t, args: n, name: r });
    if (!s) throw new z(r, { docsPath: Vr });
    o = s;
  }
  if (o.type !== "function") throw new z(void 0, { docsPath: Vr });
  return { abi: [o], functionName: O(P(o)) };
}
function _r(e) {
  let { args: t } = e,
    { abi: n, functionName: r } =
      e.abi.length === 1 && e.functionName?.startsWith("0x") ? e : Wr(e),
    o = n[0],
    s = r,
...
function Zr(e, r) {
  ...
  return new lt(s, b({ docsPath: t }, n));
}
...
function Qr(e) {
  ...
  return (
    typeof e.authorizationList < "u" &&
      (t.authorizationList = ss(e.authorizationList)),
    ...
    schedule(d) {
      return M(this, null, function* () {
        ...
        return (
          n?.([...a(), d]) && s(),
          c().length > 0
            ? (p({ args: d, resolve: l, reject: h }), m)
            : (p({ args: d, resolve: l, reject: h }), setTimeout(s, r), m)
        );
      });
    },
  };
...
function ro(e) {
  ...
  for (let n of e) {
    let r = n,
      { address: o } = r,
      s = H(r, ["address"]);
    if (!w(o, { strict: !1 })) throw new T({ address: o });
    if (t[o]) throw new pt({ address: o });
    t[o] = is(s);
  }
  return t;
}
...
function so(e) {
  let {
    ...
    i = t ? ne(t) : void 0;
  if (i && !w(i.address)) throw new T({ address: i.address });
  if (s && !w(s)) throw new T({ address: s });
  if (typeof n < "u" && (typeof r < "u" || typeof o < "u")) throw new ft();
  if (r && r > oo) throw new q({ maxFeePerGas: r });
  if (o && r && o > r)
    throw new X({ maxFeePerGas: r, maxPriorityFeePerGas: o });
}
function io(e, t) {
  return M(this, null, function* () {
    let jn = t,
    ...
    let En = f && d,
      ...
      mo = En
        ? cs({ code: f, data: d })
        : Bn
        ? ps({ data: d, factory: m, factoryData: l, to: te })
        : d;
    try {
      so(t);
      ...
      if (o && as({ request: vt }) && !Y && !J)
        try {
          return yield us(e, A(b({}, vt), { blockNumber: s, blockTag: i }));
        } catch (W) {
          if (!(W instanceof Ie) && !(W instanceof Z)) throw W;
        }
      let yo = (() => {
          let W = [vt, Ae];
          return Y && J ? [...W, Y, J] : Y ? [...W, Y] : J ? [...W, {}, J] : W;
        })(),
        Rn = yield e.request({ method: "eth_call", params: yo });
      return Rn === "0x" ? { data: void 0 } : { data: Rn };
    } catch (wt) {
      let Ae = ds(wt),
        { offchainLookup: J, offchainLookupSignature: Y } = yield import(
          "./chunk-OE4OGKQT.js"
        );
      if (e.ccipRead !== !1 && Ae?.slice(0, 10) === Y && te)
        return { data: yield J(e, { data: Ae, to: te }) };
      throw Sn && Ae?.slice(0, 10) === "0x101bb98d"
        ? new mt({ factory: m })
        : Zr(wt, A(b({}, t), { account: Mn, chain: e.chain }));
    }
  });
}
...
function us(e, t) {
  return M(this, null, function* () {
    let { batchSize: n = 1024, wait: r = 0 } =
      ...
      p = a;
    if (!p) {
      if (!e.chain) throw new Ie();
      p = qr({ blockNumber: o, chain: e.chain, contract: "multicall3" });
    }
    let d = (typeof o == "bigint" ? y(o) : void 0) || s,
        ...
        fn: (g) =>
          M(this, null, function* () {
            let V = g.map((ke) => ({
              ...
              ve = _r({ abi: St, args: [V], functionName: "aggregate3" }),
              $e = yield e.request({
                method: "eth_call",
      ...
      [{ returnData: l, success: h }] = yield m({ data: i, to: c });
    if (!h) throw new yt({ data: l });
...
function ao(e, t) {
  if (!w(e, { strict: !1 })) throw new T({ address: e });
  if (!w(t, { strict: !1 })) throw new T({ address: t });
...
function uo(e) {
  ...
  if (!o) throw new Je(r, { docsPath: "/docs/contract/decodeFunctionData" });
  return {
    functionName: o.name,
    args:
...
function An(e) {
  let { abi: t, errorName: n, args: r } = e,
    o = t[0];
  if (n) {
    let c = U({ abi: t, args: r, name: n });
    if (!c) throw new Me(n, { docsPath: $n });
    o = c;
  }
  if (o.type !== "error") throw new Me(void 0, { docsPath: $n });
  let s = P(o),
    i = O(s),
    a = "0x";
  if (r && r.length > 0) {
    if (!o.inputs) throw new Xe(o.name, { docsPath: $n });
    a = C(o.inputs, r);
  }
  return Q([i, a]);
}
...
function co(e) {
  let { abi: t, functionName: n, result: r } = e,
    o = t[0];
  if (n) {
    let i = U({ abi: t, name: n });
    if (!i) throw new z(n, { docsPath: Pn });
    o = i;
  }
  if (o.type !== "function") throw new z(void 0, { docsPath: Pn });
  if (!o.outputs) throw new se(o.name, { docsPath: Pn });
  let s = (() => {
    ...
    return (
      yield Promise.all(
        r.map((i, a) =>
          M(this, null, function* () {
            try {
              (s[a] = i.urls.includes(In)
                ? yield Tn({ data: i.data, ccipRequest: n })
                : yield n(i)),
                (o[a] = !1);
            } catch (c) {
              (o[a] = !0), (s[a] = fs(c));
      ...
      co({ abi: He, functionName: "query", result: [o, s] })
    );
  });
}
function fs(e) {
  return e.name === "HttpRequestError" && e.status
    ? An({ abi: He, errorName: "HttpError", args: [e.status, e.shortMessage] })
    : An({
        abi: [Ne],
        errorName: "Error",
...
function G0(s, i) {
  return M(
    ...
    function* (e, { blockNumber: t, blockTag: n, data: r, to: o }) {
      let { args: a } = at({ data: r, abi: [ls] }),
        [c, p, f, d, m] = a,
        { ccipRead: l } = e,
        h = l && typeof l?.request == "function" ? l.request : ms;
      try {
        if (!ao(o, c)) throw new gt({ sender: c, to: o });
        let g = p.includes(In)
            ? yield Tn({ data: f, ccipRequest: h })
            : yield h({ data: f, sender: c, urls: p }),
          { data: V } = yield io(e, {
            blockNumber: t,
            blockTag: n,
            data: D([d, C([{ type: "bytes" }, { type: "bytes" }], [g, m])]),
            to: o,
          });
        return V;
      } catch (g) {
  ...
  return M(this, arguments, function* ({ data: e, sender: t, urls: n }) {
    ...
    for (let s = 0; s < n.length; s++) {
      ...
      try {
        ...
        if (!B(d)) {
          o = new xt({ result: d, url: i });
          continue;
        }
        return d;
      } catch (f) {
        o = new Ce({ body: c, details: f.message, url: i });
      }
    }
    throw o;
  });
